	...
	public LoginForm() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(service.verifyAdmin(username,password)) {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Open Page 2 when button is clicked
                RegisterForm registerForm = new RegisterForm(); // Create instance of Page2
                registerForm.setVisible(true); // Make Page2 visible
                setVisible(false); // Hide Page1
			}
		});
		...
		lblNewLabel_2.setBounds(549, 86, 300, 82);
		...
		btnNewButton_3.setBounds(35, 618, 117, 48);
